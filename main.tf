...
#All resources in this project will be name in AWS using this unique pet name using name tags
resource "random_pet" "name" {}

#The SSH Key Pair is definded here.  We use a public key in the reference, but this needs to be set up specific to your private keys
